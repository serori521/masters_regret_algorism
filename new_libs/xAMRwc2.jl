...
xAMRwc2(PCM, method)とすることで，区間重要度が求められる．
...
# eAMRw/c, gAMRw/c (step3の目的関数を変更したバージョン)
@inline function xAMRwc2(A::Matrix{T}, method::Function)::LPResult_Individual{T} where {T<:Real}
